...
xnoremap ZR <Plug>(vimtex-compile-selected)
...
set errorfile=~/Documentos/LaTeX/top-an/espacios-conexos.blg
...
badd +1 teoria-medida.tex
badd +1984 ~/Documentos/LaTeX/top-an/espacios-conexos.tex
badd +1 ~/Documentos/LaTeX/reference.bib
badd +901 ~/.vim/vim-snips/tex.snippets
badd +1 ./tipos-espacios.tex
badd +1 hilbert.tex
badd +47 ~/Documentos/Tareas/reference.bib
badd +1 ~/Documentos/LaTeX/top-an/topologia-analisis.tex
argglobal
%argdel
$argadd teoria-medida.tex
set stal=2
...
tabnew +setlocal\ bufhidden=wipe
tabrewind
edit ~/Documentos/LaTeX/top-an/topologia-analisis.tex
argglobal
balt teoria-medida.tex
let s:cpo_save=&cpo
set cpo&vim
...
silent! normal! zE
let &fdl = &fdl
let s:l = 74 - ((16 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 74
...
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <nowait> <silent> <C-J> =UltiSnips#JumpBackwards()
imap <buffer> <nowait> <silent> <F7> <Plug>(vimtex-cmd-create)
inoremap <buffer> <silent> <expr> <Plug>(vimtex-delim-close) vimtex#delim#close()
inoremap <buffer> <silent> <Plug>(vimtex-cmd-create) =vimtex#cmd#create_insert()
snoremap <buffer> <nowait> <silent> <NL> :call UltiSnips#JumpBackwards()
omap <buffer> <nowait> <silent> % <Plug>(vimtex-%)
xmap <buffer> <nowait> <silent> % <Plug>(vimtex-%)
nmap <buffer> <nowait> <silent> K <Plug>(vimtex-doc-package)
omap <buffer> <nowait> <silent> [* <Plug>(vimtex-[*)
...
xnoremap <buffer> <silent> <SNR>111_(vimtex-[/) :call vimtex#motion#comment(1,1,1)
xnoremap <buffer> <silent> <SNR>111_(vimtex-[*) :call vimtex#motion#comment(0,1,1)
snoremap <buffer> <nowait> <silent> <C-J> :call UltiSnips#JumpBackwards()
nmap <buffer> <nowait> <silent> <F8> <Plug>(vimtex-delim-add-modifiers)
xmap <buffer> <nowait> <silent> <F7> <Plug>(vimtex-cmd-create)
nmap <buffer> <nowait> <silent> <F7> <Plug>(vimtex-cmd-create)
xmap <buffer> <nowait> <silent> <F6> <Plug>(vimtex-env-surround-visual)
...
xnoremap <buffer> <silent> <Plug>(vimtex-cmd-toggle-frac) :call vimtex#cmd#toggle_frac_visual()
xnoremap <buffer> <silent> <Plug>(vimtex-cmd-create) :call vimtex#cmd#create_visual()
inoremap <buffer> <nowait> <silent> <NL> =UltiSnips#JumpBackwards()
imap <buffer> <nowait> <silent> ]] <Plug>(vimtex-delim-close)
let &cpo=s:cpo_save
unlet s:cpo_save
setlocal keymap=
...
normal! 099|
tabnext
edit ~/Documentos/LaTeX/reference.bib
argglobal
balt ~/Documentos/LaTeX/top-an/espacios-conexos.tex
let s:cpo_save=&cpo
set cpo&vim
imap <buffer> <nowait> <silent> <F7> <Plug>(vimtex-cmd-create)
inoremap <buffer> <silent> <Plug>(vimtex-cmd-create) =vimtex#cmd#create_insert()
...
silent! normal! zE
let &fdl = &fdl
let s:l = 2134 - ((17 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 2134
