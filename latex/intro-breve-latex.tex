...
\usepackage{xcolor, multicol, multirow, longtable, graphicx, enumerate}
...
\lstset{
	...
	tabsize         = 4,
	classoffset     = 1,
	morekeywords    = {\nexists, \varnothing, \complement, \beth, \gimel, \square, \blacksquare, \dfrac, \tfrac, \binom, \includegraphics, \DeclareMathOperator, \addbibresource, \printbibliography, \multirow, \eqref, \operatorname, \text, \addplot, \addlegendentry},
